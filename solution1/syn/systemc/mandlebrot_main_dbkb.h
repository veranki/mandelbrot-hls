...
#ifndef __mandlebrot_main_dbkb__HH__
#define __mandlebrot_main_dbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandlebrot_main_dbkb) {
    ...
    SC_CTOR(mandlebrot_main_dbkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
