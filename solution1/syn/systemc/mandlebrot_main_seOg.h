...
#ifndef __mandlebrot_main_seOg__HH__
#define __mandlebrot_main_seOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandlebrot_main_seOg) {
    ...
    SC_CTOR(mandlebrot_main_seOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
