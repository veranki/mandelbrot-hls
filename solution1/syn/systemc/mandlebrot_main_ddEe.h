...
#ifndef __mandlebrot_main_ddEe__HH__
#define __mandlebrot_main_ddEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandlebrot_main_ddEe) {
    ...
    SC_CTOR(mandlebrot_main_ddEe):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
