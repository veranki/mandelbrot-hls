...
HD_PWD='/mnt/f/dev/mandelbrot-hls/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mandlebrot_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mandlebrot_main.tcl
